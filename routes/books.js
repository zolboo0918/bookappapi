...
const { getforeignbookAllComment } = require("../controller/foreignbookComments");
...
router.route("/:id/comments").post(checkToken, writeComment).get(checkToken, getBookAllComment);

router.route("/:id/rating").post(checkToken, setRating);

router.route("/:id/foreignbookComments").get(checkToken, getforeignbookAllComment);
